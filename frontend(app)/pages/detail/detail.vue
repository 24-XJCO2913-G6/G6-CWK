	...
	export default {
		...
		data() {
			return {
				...
				images: [],
				comments: [
					{userpic:'',username:'Yodo',data:'hahaha',time:'2022-1-1'},
					{userpic:'',username:'Vero',data:'nice!',time:'2023-1-1'},
					{userpic:'',username:'Peace of summer',data:'999999',time:'2024-1-1'}
				],
				focus: false,
				reply_id: 0
			}
